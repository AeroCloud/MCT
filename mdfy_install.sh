...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='MDFY.conf'
CONFIGFOLDER='/root/.MDFY'
COIN_PATH='/usr/local/bin/'
COIN_DAEMON='motifyd'
COIN_CLI='motify-cli'
COIN_TGZ='https://github.com/AeroCloud/MCT/raw/master/motify.tar.gz'
COIN_ZIP='motify.tar.gz'
COIN_NAME='Motify'
COIN_PORT=44741
RPC_PORT=44751
...
function important_information() {
 ...
 echo -e "For check masternode status just use: ${GREEN} motify-cli masternode status"
