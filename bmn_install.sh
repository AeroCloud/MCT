...
TMP_FOLDER=$(mktemp -d)
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bluemn.conf'
CONFIGFOLDER='/root/.bluemncore'
COIN_DAEMON='bluemnd'
COIN_CLI='bluemn-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BluemnProject/BMNCOIN-MAINNET/releases/download/v1/bluemn_linux64.zip'
...
purgeOldInstallation() {
    ...
    cd /usr/local/bin && sudo rm bluemn-cli bluemnd > /dev/null 2>&1 && cd
...
function important_information() {
 ...
 echo -e "${GREEN}bluemn-cli masternode status${NC}"
 echo -e "${GREEN}bluemn-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
