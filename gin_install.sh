...
COIN_TGZ='https://github.com/gincoin-dev/gincoin-core/releases/download/1.1.0.0/gincoin-binaries-linux-64bit.tar.gz'
...
purgeOldInstallation() {
    ...
    cd /usr/local/bin && sudo rm gincoin-cli gincoin-tx gincoind > /dev/null 2>&1 && cd
...
function install_sentinel() {
  ...
  echo "dash_conf=$CONFIGFOLDER/gincoin.conf" >> $CONFIGFOLDER/sentinel/sentinel.conf
}
...
function download_node() {
  ...
  cp gincoin-binaries/$COIN_DAEMON gincoin-binaries/$COIN_CLI $COIN_PATH
  cd ~ >/dev/null 2>&1
...
function important_information() {
 ...
 echo -e "${GREEN}gincoin-cli masternode status${NC}"
 echo -e "${GREEN}gincoin-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
