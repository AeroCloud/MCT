...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nodebase.conf'
CONFIGFOLDER='/root/.nodebase'
COIN_PATH='/usr/local/bin/'
COIN_DAEMON='nodebased'
COIN_CLI='nodebase-cli'
COIN_TGZ='https://github.com/NodeBaseCore/NodeBaseCoin/releases/download/v1.0.1/linux.tar.gz'
COIN_ZIP='linux.tar.gz'
COIN_NAME='NodeBase'
COIN_PORT=22001
RPC_PORT=22002
...
addnode=206.189.208.80
addnode=45.76.150.28
addnode=66.42.55.49
...
function important_information() {
 ...
 echo -e "For check masternode status just use: ${GREEN} nodebase-cli masternode status"
